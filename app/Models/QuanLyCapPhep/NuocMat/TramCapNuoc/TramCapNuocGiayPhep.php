...
namespace App\Models\QuanlyCapPhep\NuocMat\TramCapNuoc;

use Illuminate\Database\Eloquent\Factories\HasFactory;
use Illuminate\Database\Eloquent\Model;

class TramCapNuocGiayPhep extends Model
{
    use HasFactory;
    public $table = "nuocmat__tramcapnuoc__giayphep";
    ...
    protected $fillable = [
        ...
        "gp_loaigiayphep",
        "congsuat_lapmay",
        "luuluonglonnhat_quatramcapnuoc",
